...
public class InitializerClientEnDecoder extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        pipeline.addLast("framer",new LengthFieldBasedFrameDecoder(1021,3,4,0,0));

        //pipeline.addLast("decoder",new StringDecoder());
        //pipeline.addLast("encoder",new StringEncoder());

        pipeline.addLast(new HandlerClientLengthFieldBased());//自定义业务逻辑Handler
    }
}
